...
#### Buttons
#TODO - image with button descripitoims
...
The **Choose Position** button will set X and Y fields into search so they will reflect the cursors current postions on your monitors and will save the positions of your next left-click.
...
Once a macro start the running row is highlights in orange and the runnignn tab is denotped with a #TODO.
