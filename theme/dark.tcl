...
namespace eval ttk::theme::sun-valley-dark {
    ...
    ttk::style theme create sun-valley-dark -parent clam -settings {
        ...
        # Notebook
        ttk::style configure TNotebook -padding 1 -font {{Arial bold italic} 17}
        ...
        font create TitleFont -size 12
        ttk::style configure TNotebook.Tab -font TitleFont

        ttk::style element create Notebook.tab \
            image [list $images(tab-selected) \
                selected $images(tab-hover2) \
                active $images(tab-hover) \
            ] -border 13 -padding {10 10 10 6} -height 32
